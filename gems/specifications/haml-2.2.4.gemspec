...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/sass/script_test.rb", "test/sass/css2sass_test.rb", "test/sass/plugin_test.rb", "test/sass/functions_test.rb", "test/sass/engine_test.rb", "test/haml/util_test.rb", "test/haml/template_test.rb", "test/haml/html2haml_test.rb", "test/haml/helper_test.rb", "test/haml/engine_test.rb"]
